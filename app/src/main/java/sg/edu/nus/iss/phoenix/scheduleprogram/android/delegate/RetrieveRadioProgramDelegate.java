...
public class RetrieveRadioProgramDelegate extends AsyncTask<String, Void, List<String>> {
    // Tag for logging
    private static final String TAG = RetrieveRadioProgramDelegate.class.getName();

    private ScheduleProgramController scheduleProgramController = null;

    public RetrieveRadioProgramDelegate(ScheduleProgramController scheduleProgramController) {
